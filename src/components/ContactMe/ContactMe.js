...
export default function () {
    return (
        <>
            <div className='bg-slate-800 min-h-screen text-white py-24 flex justify-evenly flex-col md:flex-row tilt-in-fwd-tr'>
                <div className='flex flex-col ml-4 mb-4'>
                    ...
                    <span className='font-semibold text-xl mb-4'>Seeking a dynamic web development opportunity
                    <p> to showcase my skills and grow in the IT sector!</p></span>
